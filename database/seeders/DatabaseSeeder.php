    ...
    public function run(): void
    {
        $mahasiswaData = [
            [
                ...
                'password' => Hash::make('36245578001'),
                'status_akun' => 'Aktif',
                'role' => 'mahasiswa',
            ],
            [
                ...
                'password' => Hash::make('36245578002'),
                'status_akun' => 'Aktif',
                'role' => 'mahasiswa',
            ],
            [
                ...
                'password' => Hash::make('36245578003'),
            ...
            [
                'nim_nip' => '2501301018',
                'name' => 'Ahmad Wildy',
                'email' => 'ahmadwildyrino25@mhs.politala.ac.id',
                'password' => Hash::make('2501301018'),
                'status_akun' => 'Aktif',
                'role' => 'mahasiswa',
            ]
        ];
